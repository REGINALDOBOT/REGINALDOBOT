...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ to fazendo espere 2minutos enquanto isso beba �gua ⌛',
				success: '✔️ Sucesso ✔️',
				...
				error: {
					stick: '[❗] Falha, ocorreu um erro ao converter a imagem em um adesivo so fa�o adesivo de 8segundos a menos ❌',
					Iv: '❌ Link inválido ❌'
				},
				only: {
			...
			const ownerNumber = ["5575982692667@s.whatsapp.net,(Numerodooutroowner)@s.whatsapp.net"] // replace this with your number
