...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: 'âŒ› to fazendo espere 2minutos enquanto isso beba água âŒ›',
				...
				error: {
					stick: '[â—] Falha, ocorreu um erro ao converter a imagem em um adesivo so faço adesivo de 8segundos a menos âŒ',
				...
				only: {
					...
					ownerB: '[â—] Este comando sÃ³ pode ser usado pelo DANTE aquele gostoso! âŒ',
					admin: '[â—] Este comando sÃ³ pode ser usado por administradores de grupo retardado! âŒ',
